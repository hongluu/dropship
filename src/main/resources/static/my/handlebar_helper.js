/**
 * Created by HongLM on 9/6/17.
 */
var Render = function(src,des,data){
  this.src = src;
  this.des = des;
  this.data= data;

  this.render = function(){
    var source = $(this.src).html();
    var template = Handlebars.compile(source);
    var html = template(this.data);
    $(this.des).html(html);
  };
  this.renderWithFadeIn = function(){
    this.render();
    $(this.des+'>div').fadeIn();
  };
  this.renderWithFadeOut = function(){
    this.render();
    $(this.des+'>div').fadeOut();
  }
};
